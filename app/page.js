    ...
    return (
      <div style={{ minHeight: '100vh', background: '#FAF8F4', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center' }}>
          <svg width={48} height={48} viewBox="0 0 100 100" fill="none" style={{ animation: 'spin 1.2s linear infinite' }}>
          ...
          <p style={{ color: '#6B6A66', marginTop: 14, fontSize: 13, letterSpacing: '.05em' }}>Loading…</p>
        </div>
      </div>
    )
  }
